 ...
 * @dev Defines a common interface to get NAV rate (Native Asset Value)
 */
interface ISecuritizeNavProvider {
    ...
    /**
     * @dev Set rate. It is expressed with the same decimal numbers as the liquidity token
     */
    function setRate(uint256 _rate) external;

    /**
     * @dev The asset:liquidity rate. Usage: liquidityAmount = assetAmount * rate() / assetDecimals
