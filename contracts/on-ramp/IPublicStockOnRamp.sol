...
interface IPublicStockOnRamp is IBaseOnRamp {
     ...
     * @param investorWallet Address of the investor's wallet
     ...
     */
    function calculateDsTokenAmount(uint256 _liquidityAmount, uint256 rate) external view returns (uint256 dsTokenAmount, uint256 rate, uint256 fee);
